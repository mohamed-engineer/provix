      ...
      options: [
        {
          ...
          type: "select",
          name: "platforms",
          choices: [t("Facebook"), t("Instagram"), t("Twitter"), t("Google Ads")],
        },
        {
          label: t("Budget"),
          type: "text",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          type: "select",
          name: "duration",
          choices: [t("1 Month"), t("3 Months"), t("6 Months"), t("1 Year")],
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          type: "select",
          name: "botType",
          choices: [t("Customer Service"), t("Marketing"), t("Educational"), t("Interactive")],
        },
        {
